...
import com.javagen.gen.schema.node.AttributeHolder
import com.javagen.gen.schema.node.ComplexType
import com.javagen.gen.schema.node.Element
import com.javagen.gen.schema.node.ElementHolder
...
import com.javagen.gen.schema.node.Value
            ...
            switch (tag) {
                ...
                case 'attribute':
                    ...
                    if (attributeHolder) {
                        ...
                        println "no AttributeHolder found on attributeStack, ignoring schema attriubte: ${attribute}"
                    }
                    valueStack.pop()
                    break
                case 'anyAttribute':
                ...
                case 'list':
                    ...
                    com.javagen.gen.schema.node.List list = new com.javagen.gen.schema.node.List(itemType:base)
...
//        schema = new Schema(prefixToNamespaceMap:prefixToNamespaceMap)
//        elementStack.push(schema)
//        attributeStack.push(schema)
//        indexGlobalNodes(xmlSchema)
//        traverseElements(xmlSchema)
