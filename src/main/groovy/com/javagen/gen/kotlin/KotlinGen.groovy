...
import com.javagen.gen.java.JacksonXmlCallback
import com.javagen.gen.java.JavaPreEmitter
...
import com.javagen.gen.swift.SwiftTypeRegistry
...
import static com.javagen.gen.model.MMethod.Stereotype.putter
...
class KotlinGen extends SchemaToJava
{
    ...
    MProperty genAny(String propertyName, Any any)
    {
        ...
        if (container == MCardinality.LIST) {
            ...
            MClass anyClass = MType.lookupType(anyClassName)
    ...
    def mapHashCodeMethodBody(MMethod m, MVisitor v)
    {
        v.out << 'when {'
        v.next()
