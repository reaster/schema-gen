...
import static com.javagen.gen.java.JavaTypeRegistry.*
...
//        any.type = schema.getGlobal(DEFAULT_NS, anyType) - can't modify after vistor activated - causes bugs
...
//        }
    ...
    MProperty genAny(String propertyName, Any any)
    {
        ...
        if (container == MCardinality.LIST) {
            ...
            String val = 'new java.util.TreeMap<>()'
